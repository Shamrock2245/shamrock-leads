...
| **TX** | **34** | `scrapers/counties_tx/` | Randall is source-validated; Bell, Ellis, and Guadalupe fail-closed guards are deployed, while Jefferson’s stale P2C wrapper is locally repaired to fail closed pending a booking-safe broad roster contract. |
