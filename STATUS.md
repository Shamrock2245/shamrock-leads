...
| **AL** | **16** | `scrapers/counties_al/` | Lee, Marshall, and St. Clair are deployed after bounded official-roster smokes; Etowah is repaired to its official current roster after a bounded two-page smoke and awaits deployment. Per-scraper Mongo/alert evidence remains pending. |
...
| Area | Status |
|------|--------|
| **357** registered scrapers (10 states), scoring, Slack, Mongo | ✅ Lee, Marshall, and St. Clair AL, Tangipahoa and St. Mary LA, and Miami-Dade FL deployments with public host checks passed; Etowah AL is locally source-validated and pending deployment; per-scraper Mongo/Slack evidence remains pending |
