...
| **AL** | **16** | `scrapers/counties_al/` | Lee, Marshall, St. Clair, and Etowah are deployed after bounded official-roster smokes; Madison is fail closed after removal of proxy and synthetic-ID behavior. Public hosts are healthy. Per-scraper Mongo/alert evidence remains pending. |
