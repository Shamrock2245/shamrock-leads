...
| **TX** | **34** | `scrapers/counties_tx/` | Randall is source-validated; Bell, Ellis, and Guadalupe fail-closed guards deployed 2026-08-14 with public hosts healthy. Jefferson still requires source refresh. |
