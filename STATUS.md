...
| **TX** | **34** | `scrapers/counties_tx/` | Randall is source-validated; Bell’s stale P2C wrapper is locally repaired to fail closed against the official New World search-only portal. Ellis, Guadalupe, and Jefferson still require source refresh. |
