...
| **SC** | **46** | `scrapers/counties_sc/` | York source-faithful parser repair is deployed; Lee and Lexington legacy P2C paths fail closed under the deployed `0de5f79` shared guard pending a source-safe broad roster. See `docs/LEGACY_P2C_SOURCE_SAFETY.md`. Per-county persistence and alert telemetry remain pending. |
