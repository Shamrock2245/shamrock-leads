...
| **AL** | **16** | `scrapers/counties_al/` | Lee, Marshall, St. Clair, and Etowah are deployed after bounded official-roster smokes; Madison and Mobile have fail-closed proxy/synthetic-ID removals pending production verification. Public hosts are healthy. Per-scraper Mongo/alert evidence remains pending. |
