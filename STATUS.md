...
| **NC** | **60** | `scrapers/counties_nc/` | Durham fail-closed guard is deployed; Lincoln’s stale P2C wrapper is locally repaired to the official OCV feed with a successful aggregate source smoke. North Carolina production persistence and alert telemetry remain pending. |
