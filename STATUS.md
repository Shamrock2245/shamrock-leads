...
| **TX** | **34** | `scrapers/counties_tx/` | Randall is source-validated; Bell’s fail-closed guard is deployed, while Ellis’s stale P2C wrapper is locally repaired to fail closed after its current public roster returned a challenge. Guadalupe and Jefferson still require source refresh. |
