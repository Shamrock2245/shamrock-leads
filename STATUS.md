...
| **TX** | **34** | `scrapers/counties_tx/` | Randall is source-validated; Bell’s fail-closed guard deployed 2026-08-14 with public hosts healthy. Ellis, Guadalupe, and Jefferson still require source refresh. |
