"""
Union County (FL) Arrest Scraper — STUB (No Public Roster)
Source: Union County Sheriff's Office
Status: NO PUBLIC ONLINE ROSTER — county does not publish inmate data online.
NOTE: Union County is one of Florida's smallest counties and does not maintain
...
class UnionCountyScraper(BaseScraper):
    """Union County (FL) — No public roster. Stub scraper."""
    ...
    def scrape(self) -> List[ArrestRecord]:
        logger.info(f"Union: No public roster available — returning empty")
        return []
