"""
El Paso County (TX) Arrest Scraper.

Portal: https://www.epcounty.com/sheriff/ or El Paso Jail Lookup
El Paso County is a major West Texas regional hub (~860k pop).

Dedup key: Booking_Number (Booking Number / SPN)
"""
...
PORTAL_URL = "https://www.epcounty.com/sheriff/inmates.htm"
SEARCH_URL = "https://www.epcounty.com/sheriff/inmatesearch.asp"
    ...
    def scrape(self) -> List[ArrestRecord]:
        ...
        for letter in letters:
            try:
                ...
                logger.warning(f"El Paso letter {letter} failed: {e}")

        logger.info(f"✅ El Paso (TX): {len(records)} records in {time.time() - start:.1f}s")
        return records
        ...
        for row in rows[1:]:
            ...
            out.append(
                ArrestRecord(
                    ...
                    Status="In Custody",
                    Facility="El Paso County Jail Annex",
