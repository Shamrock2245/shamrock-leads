"""
Rankin County (MS) Arrest Scraper — Brandon / Rankin Sheriff Roster.
URL: https://rankincounty.ms.gov/sheriff/inmates
"""
import logging
import time
...
class RankinScraper(BaseScraper):
    ...
    def scrape(self) -> List[ArrestRecord]:
        ...
        url = "https://rankincounty.ms.gov/api/v1/jail/roster"
        headers = {
        ...
        try:
            ...
            logger.info(f"Rankin MS scrape info: {e}")
        return records
