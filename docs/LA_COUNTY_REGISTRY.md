...
| Grant, Union | LA VINE roster directory; parish sheriff sites | **Revalidated 2026-08-15 — recon only; no registration.** The current official LCLE LA VINE parish roster directory does not list Grant or Union. Grant’s public corrections page and Union’s public sheriff site expose contact or facility information but no broad roster. No separate official endpoint with complete identity, a source-issued booking/inmate identifier, and booking date/time was verified. Retain no scraper until a compliant public listing appears. |
