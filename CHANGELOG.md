...
- **Lee Alabama parser regression tests** — verify public-card mapping, state-scoped source-key stability, fail-closed identity behavior, and pagination. A bounded local two-page official-source smoke parsed 20 records on 2026-08-14; production Mongo upsert and alert delivery remain unclaimed until their telemetry is observed.
