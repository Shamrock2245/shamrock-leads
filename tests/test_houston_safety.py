...
from scrapers.counties_al.houston import HoustonScraper


class HoustonSafetyTests(unittest.TestCase):
    ...
    def test_no_generic_parser_invocation(self):
        source = Path('scrapers/counties_al/houston.py').read_text(encoding='utf-8')
