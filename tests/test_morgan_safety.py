...
from scrapers.counties_al.morgan import MorganScraper


class MorganSafetyTests(unittest.TestCase):
    ...
    def test_no_generic_parser_invocation(self):
        source = Path('scrapers/counties_al/morgan.py').read_text(encoding='utf-8')
