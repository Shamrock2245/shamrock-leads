...
bb_prospecting_bp = Blueprint("bb_prospecting", __name__)
...
@bb_prospecting_bp.route("/prospecting/outreach", methods=["POST"])
...
@bb_prospecting_bp.route("/prospecting/group-chat", methods=["POST"])
...
@bb_prospecting_bp.route("/prospecting/stats", methods=["GET"])
...
@bb_prospecting_bp.route("/prospecting/templates", methods=["GET"])
