...
lead_intel_bp = Blueprint("lead_intelligence", __name__)
...
@lead_intel_bp.route("/leads/<booking_number>/intelligence")
...
# ── KPI Trend Stats ───────────────────────────────────────────────────────────
@lead_intel_bp.route("/leads/trend-stats")
...
@lead_intel_bp.route("/leads/<booking_number>/charge-severity")
