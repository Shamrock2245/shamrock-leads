...
# ─────────────────────────────────────────────────────────────────────────────
@analytics_bp.route("/analytics/revenue")
...
# COUNTY PERFORMANCE
# ─────────────────────────────────────────────────────────────────────────────
@analytics_bp.route("/analytics/county-performance")
async def county_performance():
    ...
    try:
        ...
        return jsonify({"success": True, "counties": result, "days": days})
    except Exception as exc:
...
# SURETY BREAKDOWN
# ─────────────────────────────────────────────────────────────────────────────
@analytics_bp.route("/analytics/surety-breakdown")
async def surety_breakdown():
    ...
    try:
        ...
        return jsonify({"success": True, "sureties": sureties})
    except Exception as exc:
...
# ─────────────────────────────────────────────────────────────────────────────
@analytics_bp.route("/analytics/heatmap")
...
# ─────────────────────────────────────────────────────────────────────────────
@analytics_bp.route("/analytics/bond-distribution")
async def bond_distribution():
    ...
    try:
        ...
        return jsonify({"success": True, "buckets": result})
    except Exception as exc:
