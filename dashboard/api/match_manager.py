...
match_manager_bp = Blueprint("match_manager", __name__)


# ─────────────────────────────────────────────────────────────────────────────
#  POST /api/bonds/match — Full manual match: POA + defendant + indemnitor
# ─────────────────────────────────────────────────────────────────────────────
@match_manager_bp.route("/bonds/match", methods=["POST"])
async def api_bonds_match():
    ...
    if not poa_number:
        return jsonify({"success": False, "error": "poa_number is required"}), 400
...
# ─────────────────────────────────────────────────────────────────────────────
@match_manager_bp.route("/bonds/unmatched", methods=["GET"])
async def api_bonds_unmatched():
    ...
    try:
        ...
        return jsonify({"success": True, "unmatched": unmatched, "total": len(unmatched)})
...
# ─────────────────────────────────────────────────────────────────────────────
@match_manager_bp.route("/bonds/<booking_number>/assign-poa", methods=["PATCH"])
async def api_assign_poa(booking_number: str):
    ...
    if not poa_number:
        return jsonify({"success": False, "error": "poa_number required"}), 400
    ...
    try:
        ...
        return jsonify({"success": True, "poa_number": poa_number})
...
# ─────────────────────────────────────────────────────────────────────────────
@match_manager_bp.route("/bonds/<booking_number>/assign-indemnitor", methods=["PATCH"])
...
# ─────────────────────────────────────────────────────────────────────────────
@match_manager_bp.route("/match-manager/search", methods=["GET"])
