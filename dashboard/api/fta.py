...
fta_bp = Blueprint("fta", __name__)


# ─────────────────────────────────────────────────────────────────────────────
# GET /api/fta/open
# ─────────────────────────────────────────────────────────────────────────────
@fta_bp.route("/fta/open", methods=["GET"])
...
# POST /api/fta/scan
# ─────────────────────────────────────────────────────────────────────────────
@fta_bp.route("/fta/scan", methods=["POST"])
...
# ─────────────────────────────────────────────────────────────────────────────
@fta_bp.route("/fta/<booking_number>/resolve", methods=["POST"])
async def api_fta_resolve(booking_number: str):
    ...
    try:
        ...
        if resolution not in valid_resolutions:
            return jsonify({"success": False, "error": "Invalid resolution value"}), 400
