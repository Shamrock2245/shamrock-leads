    ...
    try {
      ...
      if (shouldRecordBond) {
        ...
        const bondPayload = {
          ...
          indemnitor_dl: (document.getElementById('baIndemDL')?.value || '').trim(),
          indemnitor_dob: (document.getElementById('baIndemDOB')?.value || '').trim(),
          indemnitor_address: (document.getElementById('baIndemAddress')?.value || '').trim(),
          defendant_dl: (document.getElementById('baDefDL')?.value || '').trim(),
          defendant_dob: (document.getElementById('baDefDOB')?.value || '').trim(),
          defendant_address: (document.getElementById('baDefAddress')?.value || '').trim(),
