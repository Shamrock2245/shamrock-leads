...
NODE_RED_SCHEDULE = [
    ...
    {
        "id": "osint-hot-leads-morning",
        "cron": "0 9 * * *",
        "tz": "America/New_York",
        "method": "POST",
        "path": "/api/automation/osint-hot-leads",
        "body": {
            "hours_back": 24,
            "min_score": 70,
            "limit": 5,
        ...
        "slack": "#leads",
        "desc": "Queue Maigret OSINT for recent hot leads (Blackbird only if email)",
    },
    {
        "id": "osint-worker-health",
        "cron": "0 */6 * * *",
        "tz": "America/New_York",
        "method": "GET",
        "path": "/api/automation/osint-status",
        "body": None,
        "slack": "#scraper-errors",
        "desc": "Probe osint-worker readiness (Maigret/Blackbird)",
    },
]
