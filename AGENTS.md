...
1. **Scrapes** county jail rosters across **FL / GA / SC / NC / TN / TX / LA / AL / CT / MS** on scheduled intervals `[IMPLEMENTED — 354 registered scrapers · 67 FL · 85 GA · 60 NC · 46 SC · 34 TX · 22 TN · 14 AL · 11 LA · 9 MS · 6 CT]`
...
8. **Powers Multi-State Query Engine** robust query builder matching all 10 states and **354** county labels with regex case-insensitivity and dynamic county selector `[IMPLEMENTED]`
